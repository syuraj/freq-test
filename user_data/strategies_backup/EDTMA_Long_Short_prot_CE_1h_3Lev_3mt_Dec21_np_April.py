...
class EDTMA_Long_Short_prot_CE_1h_3Lev_3mt_Dec21_np_April(IStrategy):
    ...
    (((hit)))
            docker-compose run --rm freqtrade backtesting --strategy EDTMA_Long_Short_prot_CE_1h_3Lev_3mt_Dec21_np_April -i 1h --export trades --breakdown month --timerange 20211101-20221208
