...
class picasso_slope_is_dope_adx_1h_2Lev_dec15_np_Jan20(IStrategy):

    '''
    max-trades : 3


            freqtrade backtesting --strategy picasso_slope_is_dope_adx_1h_2Lev_dec15_np_Jan20 -i 1h --export trades --breakdown month --timerange 20211101-20221208
            freqtrade hyperopt --hyperopt-loss SharpeHyperOptLoss --spaces all --strategy picasso_slope_is_dope_adx_1h_2Lev_dec15_np_Jan20 -e 155 --ignore-missing-spaces -i 1h --timerange 20220101-20221208 --random-state 10102
