...
# docker run --rm -it -v ./user_data:/freqtrade/user_data:rw --cpus=0.95 freqtradeorg/freqtrade:stable backtesting --config /freqtrade/user_data/configs_backtest/config_dev.json --strategy $1 --timerange 20231201-20231210
